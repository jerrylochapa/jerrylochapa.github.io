...
while ($result_ar = mysqli_fetch_assoc($result)) {
    echo "<tr class=\"$class\">";
    echo "<td><a href='contents/joyofphp/viewcar.php?VIN=".$result_ar['VIN']."'>" . $result_ar['Make'] . "</a></td>";
    echo "<td>" . $result_ar['Model'] . "</td>";
       echo "<td>" . $result_ar['ASKING_PRICE'] . "</td>";
        echo "<td><a href='contents/joyofphp/FormEdit.php?VIN=".$result_ar['VIN']."'>Edit</a>  <a href='contents/joyofphp/deletecar.php?VIN=".$result_ar['VIN']."'>Delete</a></td>";
   echo "</tr>\n";
